...
import { deletFilesFromCloudinary, emitEvent, uploadFilesOnCloudinary } from "../utils/features.js";
...
const removeMember = TryCatch(async(req, res, next)=>{
  ...
  if (chat.creator.toString() === userId.toString())
    return next(new ErrorHandler("You are not allowed to remove yourself", 403));
